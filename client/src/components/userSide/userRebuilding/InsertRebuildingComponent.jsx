...
const InsertRebuildingComponent = ({homeNumbers,insertRebuilding})=>{
    ...
    return(
        <Fragment>
            ...
            <div>
                ...
                <p onClick={()=>{
                    insertRebuilding({description,
                        deadline,
                        startDate,
                        homeNumber})
                }} style={{marginTop:25,backgroundColor:"green",color:"white",textAlign:"center",padding:5}}>ثبت گزارش بازسازی</p>
            </div>
        </Fragment>
    )
}

export default InsertRebuildingComponent
